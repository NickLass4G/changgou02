...
public class RabbitMQConfig {
    ...
    public static final String PAGE_CREATE_QUEUE = "page_create_queue"; // 生成静态页面队列
    ...
    @Bean
    public Binding PAGE_CREATE_QUEUE_BINGDING(@Qualifier(PAGE_CREATE_QUEUE) Queue queue,@Qualifier(GOODS_UP_EXCHANGE) Exchange exchange){
        return BindingBuilder.bind(queue).to(exchange).with("").noargs();
    }
